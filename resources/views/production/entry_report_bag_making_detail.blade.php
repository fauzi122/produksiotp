					...
					<div class="card-body p-4">
						...
						<div class="col-sm-12">
							<div class="mt-4 mt-lg-0">
								<form method="post" action="/production-ent-report-bag-making-update"
									...
									<div class="row mb-4 field-wrapper required-field">
										...
										<div class="col-sm-9">
											<select class="form-select data-select2" name="id_known_by" id="id_known_by"
												...
												<option value="{{ $data_for->id }}" {{ $data_for->id ==
													$data[0]->known_by ? 'selected' : '' }} >{{ $data_for->name}}
												</option>
												@endforeach
											</select>
			...
			<div class="col-lg-6">
				<div class="card">
					...
					<div class="card-body p-4" id="preparationCheck">
						...
						<form method="post" action="/production-ent-report-bag-making-update#preparationCheck"
							class="form-material m-t-40" enctype="multipart/form-data">
							@csrf
							<input type="hidden" class="form-control" name="request_id"
								value="{{ Request::segment(2) }}">
							...
							<div class="row mb-3 field-wrapper">
								<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
										class="mdi mdi-arrow-right text-primary me-1"></i>Pisau Seal
									<code>*</code></label>
								<div class="col-sm-6">
									<div class="form-check">
							...
							<div class="row mb-3 field-wrapper">
								<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
										class="mdi mdi-arrow-right text-primary me-1"></i>Pembuka Plastik
									<code>*</code></label>
								<div class="col-sm-6">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="pc_pembuka_plastik"
											value="Ok" {{
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="pc_pembuka_plastik"
											value="Not Ok" {{ $data_detail_preparation[0]->pembuka_plastik=="Not
										Ok"?'checked':''; }} >
										<label>
											Not OK
										</label>
							...
							<div class="row mb-3 field-wrapper">
								<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
										class="mdi mdi-arrow-right text-primary me-1"></i>Guide Rubber Roll
									<code>*</code></label>
								<div class="col-sm-6">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="pc_guide_rubber_roll"
											value="Ok" {{
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="pc_guide_rubber_roll"
											value="Not Ok" {{ $data_detail_preparation[0]->guide_rubber_roll=="Not
										Ok"?'checked':''; }} >
										<label>
											Not OK
										</label>
			...
			<div class="col-lg-6">
				<div class="card">
					...
					<div class="card-body p-4" id="hygieneCheck">
						...
						<form method="post" action="/production-ent-report-bag-making-update#hygieneCheck"
							class="form-material m-t-40" enctype="multipart/form-data">
							@csrf
							<input type="hidden" class="form-control" name="request_id"
								value="{{ Request::segment(2) }}">
							<div class="row mb-3 field-wrapper">
								<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
										class="mdi mdi-arrow-right text-primary me-1"></i>Roll Guide Roll Karet
									<code>*</code></label>
								<div class="col-sm-6">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="hc_roll_guide_roll_karet"
											value="Ok" {{
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="hc_roll_guide_roll_karet"
											value="Not Ok" {{ $data_detail_hygiene[0]->roll_guide_roll_karet=="Not
										Ok"?'checked':''; }} >
										<label>
											Not OK
										</label>
									...
									<div class="text-danger"><b>{{ $errors->first('hc_roll_guide_roll_karet') }}</b>
									</div>
									@endif
								</div>
							</div>
							...
							<div class="row mb-3 field-wrapper">
								...
								<div class="col-sm-6">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="hc_jarum_perforasi"
											value="Ok" {{ $data_detail_hygiene[0]->jarum_perforasi=="Ok"?'checked':'';
										}} >
										<label class="form-check-label">
											OK
										</label>
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="hc_jarum_perforasi"
											value="Not Ok" {{ $data_detail_hygiene[0]->jarum_perforasi=="Not
										Ok"?'checked':'' }} >
										<label>
											Not OK
										</label>
							...
							<div class="row mb-3 field-wrapper">
								...
								<div class="col-sm-6">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="hc_pembuka_plastik"
											value="Ok" {{ $data_detail_hygiene[0]->pembuka_plastik=="Ok"?'checked':'';
										}} >
										<label class="form-check-label">
											OK
										</label>
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="hc_pembuka_plastik"
											value="Not Ok" {{ $data_detail_hygiene[0]->pembuka_plastik=="Not
										Ok"?'checked':''; }} >
										<label>
											Not OK
										</label>
						...
						<div class="row">
							<div class="col-lg-5">
								<div class="card">
									...
									<div class="card-body p-4">
										<form method="post"
											action="/production-entry-report-bag-making-detail-production-result-add#detailTableSection"
											class="form-material m-t-40" enctype="multipart/form-data">
											@csrf
											<div class="row mb-4 field-wrapper required-field">
												...
												<div class="col-sm-8">
													<select class="form-select data-select2" name="id_work_orders"
														...
														<option value="{{ $data->id }}"
															...
															data-wo_number="{{ $data->wo_number }}" {{ !empty($last) &&
															($data->id == $last->id_work_orders) ? 'selected' : '' }}>{{
															$data->wo_number }}</option>
														@endforeach
													</select>
											...
											<div class="row mb-4 field-wrapper">
												...
												<div class="col-sm-8 mt-3">
													...
													<div class="text-danger"><b>{{
															$errors->first('used_next_shift_barcode') }}</b></div>
													@endif
												</div>
											</div>
											<div class="row mb-4 field-wrapper required-field">
												<label for="horizontal-firstname-input"
													class="col-sm-4 col-form-label">Weight Starting </label>
												<div class="col-sm-8">
													<input type="text" class="form-control" name="weight_starting"
														value="{{ !empty($last) ? $last->weight_starting : '' }}">
													@if($errors->has('weight_starting'))
													<div class="text-danger"><b>{{ $errors->first('weight_starting')
															}}</b></div>
													@endif
												</div>
											</div>
											<div class="row mb-4 field-wrapper required-field">
												<label for="horizontal-firstname-input"
													class="col-sm-4 col-form-label">Amount Result </label>
												<div class="col-sm-8">
													<input type="text" class="form-control" name="amount_result"
														id="amount_result"
														value="{{ !empty($last) ? $last->amount_result : '' }}">
													<div class="text-secondary"><b>Pcs</b></div>
													@if($errors->has('amount_result'))
													<div class="text-danger"><b>{{ $errors->first('amount_result')
															}}</b></div>
													@endif
												</div>
											</div>
											<div class="row mb-4 field-wrapper required-field">
												<label for="horizontal-firstname-input"
													class="col-sm-4 col-form-label mt-4">PCS Per Wrap </label>
												<div class="col-sm-8">
													<span class="badge bg-secondary-subtle text-secondary">
														( Estimasi Jumlah PCS Per Bungkus/Wrap )
													</span>
													<input type="text" class="form-control mt-1" name="pcs_wrap"
														id="pcs_wrap"
														value="{{ !empty($last) ? $last->pcs_wrap : '' }}">
													<!--input type="hidden" class="form-control mt-1" name="pcs_wrap"-->
													<div class="text-secondary">
														<b>Pcs</b>
													</div>
													@if($errors->has('pcs_wrap'))
													<div class="text-danger"><b>{{ $errors->first('pcs_wrap') }}</b>
													</div>
													@endif
												</div>
											</div>
											...
											<div class="row mb-4 field-wrapper">
												<label for="horizontal-firstname-input"
													class="col-sm-4 col-form-label">Wrap</label>
												<div class="col-sm-8">
											...
											<div class="row mb-4 field-wrapper">
												<label for="horizontal-firstname-input"
													class="col-sm-4 col-form-label">Wrap Note </label>
												<div class="col-sm-8">
													<textarea rows="5" class="form-control" name="keterangan">
														{{ !empty($last) ? $last->keterangan : '' }}
													</textarea>
													@if($errors->has('keterangan'))
													<div class="text-danger"><b>{{ $errors->first('keterangan') }}</b>
													</div>
													@endif
												</div>
											</div>
								...
								<div class="card">
									...
									<div class="card-body p-4" id="detailTableSection">
										...
										<div class="alert alert-danger alert-dismissible alert-label-icon label-arrow fade show"
											role="alert">
											<i
												class="mdi mdi-alert-octagon-outline label-icon"></i><strong>Perhatian</strong><br>Jika
											data detail <b>production result</b> belum disesuaikan. Data stok <b>tidak
												bisa</b> di update.
								...
								<div class="card">
									...
									<div class="card-body p-4">
										@if(!empty($data_detail_waste[0]))
											<div class="table-responsive">
												<table id="datatable-waste" class="table table-bordered dt-responsive  nowrap w-100">
													<thead>
														<tr>
														<tr>
