...
<div class="page-content">
	<div class="container-fluid">
		...
		<div class="alert alert-danger alert-dismissible alert-label-icon label-arrow fade show" role="alert">
			<i class="mdi mdi-alert-octagon-outline label-icon"></i><strong>Dangers</strong> - {{
			session('pesan_danger') }}
			<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
		</div>
		@endif
		@if(!empty($data[0]))
					...
					<div class="card-body p-4">
						...
						<div class="col-sm-12">
							<div class="mt-4 mt-lg-0">
								<form method="post" action="/production-ent-report-slitting-update"
									class="form-material m-t-40" enctype="multipart/form-data">
									@csrf
									<input type="hidden" class="form-control" name="request_id"
										value="{{ Request::segment(2) }}">
									<div class="row mb-4 field-wrapper required-field">
										<label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Report
											Number</label>
										<div class="col-sm-9">
											<input type="text" name="report_number" class="form-control"
												value="{{ $data[0]->report_number }}" readonly>
										</div>
									</div>
									<div class="row mb-4 field-wrapper required-field">
									...
									<div class="row mb-4 field-wrapper required-field">
										<label for="horizontal-password-input" class="col-sm-3 col-form-label">Customers
										</label>
										<div class="col-sm-9">
											<select class="form-select data-select2" name="id_master_customers"
												id="id_master_customers">
												<option value="">** Please Select A Customers</option>
											</select>
											@if($errors->has('id_master_customers'))
											<div class="text-danger"><b>{{ $errors->first('id_master_customers') }}</b>
											</div>
											@endif
										</div>
									</div>
									<div class="row mb-4 field-wrapper required-field">
										<label for="horizontal-password-input" class="col-sm-3 col-form-label">Work
											Centers </label>
										<div class="col-sm-9">
											<select class="form-select data-select2" name="id_master_work_centers"
												id="id_master_work_centers" required>
												<option value="">** Please Select A Work Centers</option>
											</select>
											@if($errors->has('id_master_work_centers'))
											<div class="text-danger"><b>{{ $errors->first('id_master_work_centers')
													}}</b></div>
											@endif
										</div>
									</div>
									<div class="row mb-4 field-wrapper required-field">
										<label for="horizontal-password-input" class="col-sm-3 col-form-label">Regu
										</label>
										<div class="col-sm-9">
											<select class="form-select data-select2" name="id_master_regus"
												id="id_master_regus" required>
												<option value="">** Please Select A Regu</option>
											</select>
											@if($errors->has('id_master_regus'))
											<div class="text-danger"><b>{{ $errors->first('id_master_regus') }}</b>
											</div>
											@endif
										</div>
									</div>
									<div class="row mb-4 field-wrapper required-field">
										<label for="horizontal-password-input" class="col-sm-3 col-form-label">Shift
										</label>
										<div class="col-sm-9">
									...
									<div class="row mb-4 field-wrapper">
										<label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Engine
											Shutdown Description </label>
										<div class="col-sm-9">
											<textarea rows="5" class="form-control"
												name="engine_shutdown_description">{{ $data[0]->engine_shutdown_description }}</textarea>
											@if($errors->has('engine_shutdown_description'))
											<div class="text-danger"><b>{{ $errors->first('engine_shutdown_description')
													}}</b></div>
											@endif
										</div>
									</div>
									<div class="row mb-4 field-wrapper">
										<label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Note
										</label>
										<div class="col-sm-9">
											<textarea rows="5" class="form-control"
												name="note">{{ $data[0]->note }}</textarea>
											@if($errors->has('note'))
									...
									<div class="row mb-4 field-wrapper required-field">
										<label for="horizontal-password-input" class="col-sm-3 col-form-label">Ketua
											Regu </label>
										<div class="col-sm-9">
											<select class="form-select data-select2" name="id_ketua_regu"
												id="id_ketua_regu" required>
												<option value="">** Please Select A Ketua Regu</option>
												@foreach ($ms_ketua_regu as $data_for)
												<option value="{{ $data_for->id }}" {{ $data_for->id ==
													$data[0]->ketua_regu ? 'selected' : '' }} >{{ $data_for->name}}
												</option>
												@endforeach
											</select>
									...
									<div class="row mb-4 field-wrapper required-field">
										<label for="horizontal-password-input" class="col-sm-3 col-form-label">Operator
										</label>
										<div class="col-sm-9">
											<select class="form-select data-select2" name="id_operator" id="id_operator"
												required>
												<option value="">** Please Select A Operator</option>
												@foreach ($ms_operator as $data_for)
												<option value="{{ $data_for->id }}" {{ $data_for->id ==
													$data[0]->operator ? 'selected' : '' }}>{{ $data_for->name }}
												</option>
												@endforeach
											</select>
											...
											<input type="hidden" name="id_cms_user" class="form-control"
												value="{{ Auth::user()->id }}">
										</div>
									</div>
									<div class="row mb-4 field-wrapper required-field">
										<label for="horizontal-password-input" class="col-sm-3 col-form-label">Known By
										</label>
										<div class="col-sm-9">
											<select class="form-select data-select2" name="id_known_by" id="id_known_by"
												required>
												<option value="">** Please Select A Known By</option>
												@foreach ($ms_known_by as $data_for)
												<option value="{{ $data_for->id }}" {{ $data_for->id ==
													$data[0]->know_by ? 'selected' : '' }} >{{ $data_for->name}}
												</option>
												@endforeach
											</select>
									...
									<div class="row justify-content-end">
										<div class="col-sm-9">
											<div>
												<button type="submit" class="btn btn-success w-md" name="rb_update"><i
														class="bx bx-save" title="Back"></i> UPDATE</button>
											</div>
										</div>
									</div>
								</form>
						...
						<form method="post" action="/production-ent-report-slitting-update#preparationCheck" ...>
							...
							{{-- <form method="post" action="/production-ent-report-slitting-update"
								...
								<div class="row mb-3 field-wrapper">
									<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
											class="mdi mdi-arrow-right text-primary me-1"></i>Material
										<code>*</code></label>
									<div class="col-sm-6">
										...
										<div class="form-check">
											<input class="form-check-input" type="radio" name="pc_material"
												value="Not Ok" {{ $data_detail_preparation[0]->material=="Not
											Ok"?'checked':''; }} >
											<label>
												Not OK
											</label>
								...
								<div class="row mb-3 field-wrapper">
									<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
											class="mdi mdi-arrow-right text-primary me-1"></i>Ukuran
										<code>*</code></label>
									<div class="col-sm-6">
										<div class="form-check">
								...
								<div class="row mb-3 field-wrapper">
									<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
											class="mdi mdi-arrow-right text-primary me-1"></i>Press Roll
										<code>*</code></label>
									<div class="col-sm-6">
										<div class="form-check">
										...
										<div class="form-check">
											<input class="form-check-input" type="radio" name="pc_press_roll"
												value="Not Ok" {{ $data_detail_preparation[0]->press_roll=="Not
											Ok"?'checked':''; }} >
											<label>
												Not OK
											</label>
								...
								<div class="row mb-3 field-wrapper">
									<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
											class="mdi mdi-arrow-right text-primary me-1"></i>Rubber Roll
										<code>*</code></label>
									<div class="col-sm-6">
										<div class="form-check">
											<input class="form-check-input" type="radio" name="pc_rubber_roll"
												value="Ok" {{
										...
										<div class="form-check">
											<input class="form-check-input" type="radio" name="pc_rubber_roll"
												value="Not Ok" {{ $data_detail_preparation[0]->rubber_roll=="Not
											Ok"?'checked':''; }} >
											<label>
												Not OK
											</label>
								...
								<div class="row justify-content-end">
									<div class="col-sm-3">
										<div>
											<button type="submit" class="btn btn-success w-md" name="pc_update"><i
													class="bx bx-save" title="Back"></i> UPDATE</button>
										</div>
									</div>
								</div>
					...
					<div class="card-body p-4" id="hygieneCheck">
						<form method="post" action="/production-ent-report-slitting-update#hygieneCheck" ...>
							...
							{{-- <form method="post" action="/production-ent-report-slitting-update"
								...
								<div class="row mb-3 field-wrapper">
									<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
											class="mdi mdi-arrow-right text-primary me-1"></i>Press Rubber Roll
										<code>*</code></label>
									<div class="col-sm-6">
										<div class="form-check">
											<input class="form-check-input" type="radio" name="hc_press_rubber_roll"
												value="Ok" {{
										...
										<div class="form-check">
											<input class="form-check-input" type="radio" name="hc_press_rubber_roll"
												value="Not Ok" {{ $data_detail_hygiene[0]->press_rubber_roll=="Not
											Ok"?'checked':''; }} >
											<label>
												Not OK
											</label>
										...
										<div class="text-danger"><b>{{ $errors->first('hc_press_rubber_roll') }}</b>
										</div>
										@endif
									</div>
								</div>
								...
								<div class="row mb-3 field-wrapper">
									<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
											class="mdi mdi-arrow-right text-primary me-1"></i>Body Mesin
										<code>*</code></label>
									<div class="col-sm-6">
										<div class="form-check">
										...
										<div class="form-check">
											<input class="form-check-input" type="radio" name="hc_body_mesin"
												value="Not Ok" {{ $data_detail_hygiene[0]->body_mesin=="Not
											Ok"?'checked':''; }} >
											<label>
												Not OK
											</label>
								...
								<div class="row mb-3 field-wrapper">
									<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
											class="mdi mdi-arrow-right text-primary me-1"></i>Lantai Mesin
										<code>*</code></label>
									<div class="col-sm-6">
										<div class="form-check">
											<input class="form-check-input" type="radio" name="hc_lantai_mesin"
												value="Ok" {{ $data_detail_hygiene[0]->lantai_mesin=="Ok"?'checked':'';
											}} >
											<label class="form-check-label">
												OK
											</label>
										...
										<div class="form-check">
											<input class="form-check-input" type="radio" name="hc_lantai_mesin"
												value="Not Ok" {{ $data_detail_hygiene[0]->lantai_mesin=="Not
											Ok"?'checked':''; }} >
											<label>
												Not OK
											</label>
								...
								<div class="row mb-3 field-wrapper">
									<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
											class="mdi mdi-arrow-right text-primary me-1"></i>Cutter
										<code>*</code></label>
									<div class="col-sm-6">
										<div class="form-check">
								...
								<div class="row justify-content-end">
									<div class="col-sm-3">
										<div>
											<button type="submit" class="btn btn-success w-md" name="hc_update"><i
													class="bx bx-save" title="Back"></i> UPDATE</button>
										</div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-lg-5">
								<div class="card">
									...
									<div class="card-body p-4">
										<form method="post"
											action="/production-entry-report-slitting-detail-production-result-add#detailTableSection"
											class="form-material m-t-40" enctype="multipart/form-data">

											{{-- <form method="post"
												action="/production-entry-report-slitting-detail-production-result-add"
												class="form-material m-t-40" enctype="multipart/form-data"> --}}
												@csrf
												<div class="row mb-4 field-wrapper required-field">
													...
													<div class="col-sm-8">
														...
														@if($errors->has('start'))
														<div class="text-danger"><b>{{ $errors->first('start') }}</b>
														</div>
														@endif
														<script>
												...
												<div class="row mb-4 field-wrapper required-field">
													<label for="horizontal-password-input"
														class="col-sm-4 col-form-label">Work Orders </label>
													<div class="col-sm-8">
														<select class="form-select" name="id_work_orders"
															id="id_work_orders" required>
															<option value="">** Please Select A Work Orders</option>
															@foreach ($ms_work_orders as $data)
															<option value="{{ $data->id }}"
																data-id_master_customers="{{ $data->id_master_customers }}"
																data-type_product="{{ $data->type_product }}"
																data-id_master_products="{{ $data->id_master_products }}"
																{{ !empty($last) && ($data->id == $last->id_work_orders)
																? 'selected' : '' }}>{{ $data->wo_number }}</option>
															@endforeach
														</select>
														@if($errors->has('id_work_orders'))
														<div class="text-danger"><b>{{ $errors->first('id_work_orders')
																}}</b></div>
														@endif
													</div>
												</div>
												<script>
													// Initialize Select2 with AJAX for Work Orders
												$(document).ready(function() {
													$('#id_work_orders').select2({
														placeholder: '** Please Select A Work Orders',
														allowClear: true,
														width: '100%',
														ajax: {
															url: '/json_get_work_orders_slitting',
															dataType: 'json',
															delay: 250,
														...
														templateSelection: function(item) {
															if (item.id && item.id_master_customers) {
																var $option = $('#id_work_orders option[value="'+item.id+'"]');
																if ($option.length === 0) {
																	var newOption = new Option(item.text, item.id, true, true);
																	$(newOption).attr('data-id_master_customers', item.id_master_customers);
																	$(newOption).attr('data-type_product', item.type_product);
																	$(newOption).attr('data-id_master_products', item.id_master_products);
																	$('#id_work_orders').append(newOption);
																} else {
																	$option.attr('data-id_master_customers', item.id_master_customers);
																	$option.attr('data-type_product', item.type_product);
																	$option.attr('data-id_master_products', item.id_master_products);
																}
															}
															return item.text;
														}
												...
												<div class="row mb-4 field-wrapper required-field">
													<label for="horizontal-firstname-input"
														class="col-sm-4 col-form-label">Thickness </label>
													<div class="col-sm-8">
														<div class="input-group">
															<input id="thickness" class="form-control" name="thickness"
																type="text">
															<div class="input-group-text"
																style="background-color:rgb(197, 197, 197)">MIC</div>
														</div>
														<div class="text-danger" id="thickness_unit"></div>
														@if($errors->has('thickness'))
														<div class="text-danger"><b>{{ $errors->first('thickness')
																}}</b></div>
														@endif
													</div>
												</div>
												<div class="row mb-4 field-wrapper required-field">
													<label for="horizontal-firstname-input"
														class="col-sm-4 col-form-label">Length </label>
													<div class="col-sm-8">
														<div class="input-group">
															<input id="length" class="form-control" name="length"
																type="text">
															<div id="length_unit" class="input-group-text"
																style="background-color:rgb(197, 197, 197)">-</div>
														</div>
														@if($errors->has('length'))
														<div class="text-danger"><b>{{ $errors->first('length') }}</b>
														</div>
														@endif
													</div>
												</div>
												<div class="row mb-4 field-wrapper required-field">
													<label for="horizontal-firstname-input"
														class="col-sm-4 col-form-label">Width </label>
													<div class="col-sm-8">
														<div class="input-group">
															<input id="width" class="form-control" name="width"
																type="text">
															<div id="width_unit" class="input-group-text"
																style="background-color:rgb(197, 197, 197)">-</div>
														</div>
														@if($errors->has('width'))
														<div class="text-danger"><b>{{ $errors->first('width') }}</b>
														</div>
														@endif
													</div>
												</div>
													...
													<div class="col-sm-8">
														<div class="input-group">
															<input id="weight" class="form-control" name="weight"
																type="text">
															<div class="input-group-text"
																style="background-color:rgb(197, 197, 197)">KG</div>
														</div>
														@if($errors->has('weight'))
														<div class="text-danger"><b>{{ $errors->first('weight') }}</b>
														</div>
														@endif
													</div>
												</div>
												...
												<div class="row mb-4 field-wrapper required-field">
													<label for="horizontal-firstname-input"
														class="col-sm-4 col-form-label"><br>Status </label>
													<div class="col-sm-8">
														<div class="form-check">
															<input class="form-check-input" type="radio" name="status"
																value="Good" {{ !empty($last) &&
																($last->status)=="Good"?'checked':''; }}>
															<label>
																Good
															</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="status"
																value="Hold" {{ !empty($last) &&
																($last->status)=="Hold"?'checked':''; }}>
															<label>
																Hold
															</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="status"
																value="Reject" {{ !empty($last) &&
																($last->status)=="Reject"?'checked':''; }}>
															<label>
																Reject
															</label>
														</div>
														@if($errors->has('status'))
														<div class="text-danger"><b>{{ $errors->first('status') }}</b>
														</div>
														@endif
													</div>
												</div>
												...
												<div class="row mb-4 field-wrapper required-field">
													...
													<div class="col-sm-8">
														<select class="form-select" name="id_master_barcode_start"
															id="id_master_barcode_start">
															<option value="">** Please Select A Barcodes</option>
															@if(!empty($data_detail_production) &&
															count($data_detail_production) > 0)
															@php
															$dataArray = is_array($data_detail_production) ?
															$data_detail_production :
															$data_detail_production->toArray();
															$lastDetail = $dataArray[count($dataArray) - 1];
															@endphp
															@if(!empty($lastDetail->barcode_start) &&
															!empty($lastDetail->used_next_shift) &&
															$lastDetail->used_next_shift == '1')
															<option value="{{ $lastDetail->barcode_start }}" selected>{{
																$lastDetail->barcode_start }}</option>
															@endif
															@endif
														</select>
														@if($errors->has('id_master_barcode_start'))
														<div class="text-danger"><b>{{
																$errors->first('id_master_barcode_start') }}</b></div>
														@endif
													</div>
												</div>
												...
												<div class="row mb-4 field-wrapper">
													<label for="horizontal-password-input"
														class="col-sm-4 col-form-label">Join </label>
													<div class="col-sm-8">
														<select class="form-select data-select2" name="join" id="join">
															<option value="">** Please Select A Join</option>

															<option value="1" {{ !empty($last) && ($last->join) == '1' ?
																'selected':'' }}>1</option>
															<option value="2" {{ !empty($last) && ($last->join) == '2' ?
																'selected':'' }}>2</option>
															<option value="3" {{ !empty($last) && ($last->join) == '3' ?
																'selected':'' }}>3</option>

														</select>
														@if($errors->has('join'))
														<div class="text-danger"><b>{{ $errors->first('join') }}</b>
														</div>
														@endif
													</div>
												</div>
												<div class="row mb-4 field-wrapper">
													...
													<div class="col-sm-8 mt-3">
														...
														<div class="text-danger"><b>{{ $errors->first('used_next_shift')
																}}</b></div>
														@endif
													</div>
												</div>
												<div class="row mb-4 field-wrapper required-field">
													...
													<div class="col-sm-8">
														...
														<div class="text-danger"><b>{{
																$errors->first('id_master_barcode') }}</b></div>
														@endif
													</div>
												</div>
												<script>
													$(document).ready(function(){
														// Initialize Select2 dengan AJAX untuk Barcode Start
														$('#id_master_barcode_start').select2({
															placeholder: '** Please Select A Barcodes',
															allowClear: true,
															ajax: {
																url: '/json_get_barcode_start_slitting',
																dataType: 'json',
																delay: 250,
																data: function(params) {
																	return {
																		search: params.term,
																		page: params.page || 1,
																		type_product: $('#id_work_orders option:selected').attr('data-type_product')
																	};
																},
																processResults: function(data, params) {
																	params.page = params.page || 1;
														...
														$('#id_master_barcode').select2({
															...
															allowClear: true,
															ajax: {
																url: '/json_get_barcode_end_slitting',
																dataType: 'json',
																delay: 250,
																data: function(params) {
																	return {
														...
														@if(!empty($data_detail_production) && count($data_detail_production) > 0)
															@php
																$dataArray = is_array($data_detail_production) ? $data_detail_production : $data_detail_production->toArray();
																$lastDetail = end($dataArray);
																reset($dataArray); // Reset pointer
															@endphp
															@if(!empty($lastDetail->barcode_start) && !empty($lastDetail->used_next_shift) && $lastDetail->used_next_shift == '1')
																...
																setTimeout(function() {
																	...
																	if ($('#id_master_barcode_start').find("option[value='" + barcodeStartDefault + "']").length === 0) {
																		...
																		$('#id_master_barcode_start').val(barcodeStartDefault).trigger('change');
																	}
																}, 300);
															@endif
														@endif
														...
														$('#id_work_orders').on('change', function(e) {
															// If originalEvent is undefined, the change was triggered programmatically
														...
														// Final fallback: ensure the default Barcode Start is applied after everything
														// Only if used_next_shift is '1' (Yes)
														window.addEventListener('load', function() {
															@if(!empty($data_detail_production) && count($data_detail_production) > 0)
																...
																@if(!empty($lastDetail->barcode_start) && !empty($lastDetail->used_next_shift) && $lastDetail->used_next_shift == '1')
																	setTimeout(function() {
																		try {
																			var bs = {!! json_encode($lastDetail->barcode_start) !!};
																			if ($('#id_master_barcode_start').find("option[value='" + bs + "']").length === 0) {
																				var newOptionStart = new Option(bs, bs, true, true);
																				$('#id_master_barcode_start').append(newOptionStart).trigger('change');
																			} else {
																				$('#id_master_barcode_start').val(bs).trigger('change');
																			}
																		} catch(e) { /* silent */ }
																	}, 500);
																@endif
												...
												<div class="row mb-4 field-wrapper">
													<label for="horizontal-firstname-input"
														class="col-sm-4 col-form-label">Waste </label>
													<div class="col-sm-8">
														<input type="text" class="form-control" name="waste">
														@if($errors->has('waste'))
														<div class="text-danger"><b>{{ $errors->first('waste') }}</b>
														</div>
														@endif
													</div>
												</div>
												<div class="row mb-4 field-wrapper">
													<label for="horizontal-firstname-input"
														class="col-sm-4 col-form-label">Cause Waste </label>
													<div class="col-sm-8">
														<input type="text" class="form-control" name="cause_waste">
														@if($errors->has('cause_waste'))
														<div class="text-danger"><b>{{ $errors->first('cause_waste')
																}}</b></div>
														@endif
													</div>
												</div>
												...
												<div class="row justify-content-end">
													<div class="col-sm-12">
														<div>
															<button type="reset" class="btn btn-secondary w-md"><i
																	class="bx bx-refresh" title="Reset"></i>
																RESET</button>
															<button type="submit" class="btn btn-primary w-md"
																name="save"><i class="bx bx-list-plus" title="Add"></i>
																ADD to TABLE DETAIL</button>
														</div>
													</div>
												</div>
											</form>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<center>
																<form
																	action="/production-entry-report-slitting-detail-production-result-delete#detailTableSection"
																...
																<a href="/production-entry-report-slitting-detail-production-result-edit/{{ Request::segment(2) }}/{{ sha1($data_detail->id) }}"
