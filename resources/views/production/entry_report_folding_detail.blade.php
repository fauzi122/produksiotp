					...
					<div class="card-body p-4">
						...
						<div class="col-sm-12">
							<div class="mt-4 mt-lg-0">
								<form method="post" action="/production-ent-report-folding-update"
									...
									<div class="row mb-4 field-wrapper required-field">
										<label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Order
											Name </label>
										<div class="col-sm-9">
											<select class="form-select data-select2" name="id_master_products"
												id="id_master_products">
												<option value="">** Please Select A Products</option>
											</select>
											@if($errors->has('id_master_products'))
											<div class="text-danger"><b>{{ $errors->first('id_master_products') }}</b>
											</div>
											@endif
										</div>
									</div>
									...
									<script>
										$(document).ready(function(){
											...
											$.ajax({
												...
												data: { data_work_center : {!! $data[0]->id_master_work_centers !!}, id_master_process_productions : '3' },
												dataType: "json",
												beforeSend: function(e) {
													if(e && e.overrideMimeType) {
														e.overrideMimeType("application/json;charset=UTF-8");
									...
									<div class="row justify-content-end">
										<div class="col-sm-9">
											<div>
												<button type="submit" class="btn btn-success w-md" name="rf_update"><i
			...
			<div class="col-lg-6">
				<div class="card">
					...
					<div class="card-body p-4" id="preparationCheck">
						...
						<form method="post" action="/production-ent-report-folding-update#preparationCheck"
							class="form-material m-t-40" enctype="multipart/form-data">
							@csrf
							<input type="hidden" class="form-control" name="request_id"
								value="{{ Request::segment(2) }}">
							...
							<div class="row mb-3 field-wrapper">
								<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
										class="mdi mdi-arrow-right text-primary me-1"></i>Ukuran <code>*</code></label>
								<div class="col-sm-6">
									<div class="form-check">
							...
							<div class="row mb-3 field-wrapper">
								<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
										class="mdi mdi-arrow-right text-primary me-1"></i>Segitiga Pelipat
									<code>*</code></label>
								<div class="col-sm-6">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="pc_segitiga_pelipat"
											value="Ok" {{
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="pc_segitiga_pelipat"
											value="Not Ok" {{ $data_detail_preparation[0]->segitiga_pelipat=="Not
										Ok"?'checked':''; }} >
										<label>
											Not OK
										</label>
							...
							<div class="row mb-3 field-wrapper">
								<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
										class="mdi mdi-arrow-right text-primary me-1"></i>Jarum Perforasi
									<code>*</code></label>
								<div class="col-sm-6">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="pc_jarum_perforasi"
											value="Ok" {{
									...
									<div class="form-check">
										<input class="form-check-input" type="radio" name="pc_jarum_perforasi"
											value="Not Ok" {{ $data_detail_preparation[0]->jarum_perforasi=="Not
										Ok"?'checked':''; }} >
										<label>
											Not OK
										</label>
			...
			<div class="col-lg-6">
				<div class="card">
					...
					<div class="card-body p-4" id="hygieneCheck">
						...
						<form method="post" action="/production-ent-report-folding-update#hygieneCheck"
							class="form-material m-t-40" enctype="multipart/form-data">
							@csrf
							<input type="hidden" class="form-control" name="request_id"
								value="{{ Request::segment(2) }}">
								...
								<div class="col-sm-6">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="hc_press_rubber_roll"
											value="Ok" {{ $data_detail_hygiene[0]->press_rubber_roll=="Ok"?'checked':'';
										}} >
										<label class="form-check-label">
											OK
										</label>
							...
							<div class="row mb-3 field-wrapper">
								<label for="horizontal-firstname-input" class="col-sm-6 col-form-label"><i
										class="mdi mdi-arrow-right text-primary me-1"></i>Cutter <code>*</code></label>
								<div class="col-sm-6">
									<div class="form-check">
						...
						<div class="row">
							<div class="col-lg-5">
								<div class="card">
									...
									<div class="card-body p-4">
										<form method="post"
											action="/production-entry-report-folding-detail-production-result-add#detailTableSection"
											class="form-material m-t-40" enctype="multipart/form-data">
											@csrf
											<div class="row mb-4 field-wrapper required-field">
											...
											<script>
												$(document).ready(function(){
													// Initialize Select2 dengan AJAX untuk Work Orders
													$('#id_work_orders').select2({
														placeholder: '** Please Select A Work Orders',
														allowClear: true,
														ajax: {
															url: '/json_get_work_orders_folding',
															dataType: 'json',
															delay: 250,
											...
											<div class="row mb-4 field-wrapper">
												...
												<div class="col-sm-8">
													<select class="form-select data-select2"
														name="id_master_products_detail" id="id_master_products_detail">
														<option value="">** Please Select A Products</option>
													</select>
													@if($errors->has('id_master_products_detail'))
													<div class="text-danger"><b>{{
															$errors->first('id_master_products_detail') }}</b></div>
													@endif
												</div>
											</div>
											<div class="row mb-4 field-wrapper required-field">
												...
												<div class="col-sm-8">
													...
													<div class="text-danger"><b>{{ $errors->first('thickness') }}</b>
													</div>
													@endif
												</div>
											</div>
											...
											<div class="row mb-4 field-wrapper required-field">
												...
												<div class="col-sm-8">
													<select class="form-select" name="id_master_barcode_start"
														...
														$data_detail_production : $data_detail_production->toArray();
											...
											<script>
												$(document).ready(function(){
													...
													$('#id_master_barcode_start').select2({
														...
														allowClear: true,
														ajax: {
															url: '/json_get_barcode_start_folding',
															dataType: 'json',
															delay: 250,
															data: function(params) {
																return {
													...
													$('#id_master_barcode').select2({
														...
														allowClear: true,
														ajax: {
															url: '/json_get_barcode_end_folding',
															dataType: 'json',
															delay: 250,
															data: function(params) {
																return {
											...
											<script>
												// Prevent programmatic Work Orders change from clearing Barcode Start, and add a load-time fallback
												$(document).ready(function(){
											...
											<div class="row mb-4 field-wrapper">
												...
												<div class="col-sm-8">
													...
													<div class="text-danger"><b>{{ $errors->first('cause_waste') }}</b>
													</div>
													@endif
												</div>
											</div>
												...
												<div class="col-sm-12">
													<div>
														<button type="reset" class="btn btn-secondary w-md"><i
																class="bx bx-refresh" title="Reset"></i> RESET</button>
														<button type="submit" class="btn btn-primary w-md"
															name="save"><i class="bx bx-list-plus" title="Add"></i> ADD
															to TABLE DETAIL</button>
													</div>
												</div>
											</div>
										</form>
