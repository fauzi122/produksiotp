...
Route::middleware(['auth', 'clear.permission.cache', 'permission:Produksi|Produksi_production-req-sparepart-auxiliaries|Produksi_production-ent-report-slitting|Produksi_production-ent-report-production|Produksi_production-ent-report-folding|Produksi_production-ent-report-blow|Produksi_production-ent-report-bag-marketing|Produksi_production-ent-material-use'])->group(function () {	//Production
	...
	Route::post('/production-req-sparepart-auxiliaries-detail-edit-save/{id}', [ProductionController::class, 'production_req_sparepart_auxiliaries_detail_edit_save'])->name('production_req_sparepart_auxiliaries_detail_edit_save');
	...
	Route::get('/json_get_produk_folding', [ProductionController::class, 'jsonGetProdukFolding'])->name('jsonGetProdukFolding');
	...
	*/
	...
	// AJAX Route untuk Select2
	Route::get('/json_get_work_orders_slitting', [ProductionReportSlittingController::class, 'jsonGetWorkOrdersSlitting'])->name('jsonGetWorkOrdersSlitting');
	Route::get('/json_get_barcode_start_slitting', [ProductionReportSlittingController::class, 'jsonGetBarcodeStartSlitting'])->name('jsonGetBarcodeStartSlitting');
	Route::get('/json_get_barcode_end_slitting', [ProductionReportSlittingController::class, 'jsonGetBarcodeEndSlitting'])->name('jsonGetBarcodeEndSlitting');
	...
	// AJAX Route untuk Select2
	Route::get('/json_get_work_orders_folding', [ProductionReportFoldingController::class, 'jsonGetWorkOrdersFolding'])->name('jsonGetWorkOrdersFolding');
	Route::get('/json_get_barcode_start_folding', [ProductionReportFoldingController::class, 'jsonGetBarcodeStartFolding'])->name('jsonGetBarcodeStartFolding');
	Route::get('/json_get_barcode_end_folding', [ProductionReportFoldingController::class, 'jsonGetBarcodeEndFolding'])->name('jsonGetBarcodeEndFolding');
	...
	Route::get('/production-ent-report-rm-aux-print/{id}', [ProductionReportRmAuxOtherController::class, 'production_entry_report_rm_aux_print'])->name('production_entry_report_rm_aux_print');
